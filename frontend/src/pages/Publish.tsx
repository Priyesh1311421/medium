...
const Publish = () => {
  ...
  return (
    <div>
        ...
        <div className="flex flex-col w-full  items-center mt-10 min-h-screen">
        <div className="mb-6 w-full max-w-md ">
            <input onChange={(e)=>{
                setTitle(e.target.value)
            }} type="text" className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 "
              placeholder="Title"
            >
            </input>
        </div>
...
function TextEditor ({onChange}:{onChange:(e: ChangeEvent<HTMLTextAreaElement>)=>void}) {
    return (
        ...
        <div>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 h-full">
                ...
                <div className=" bg-white rounded-b-lg ">
                    <textarea id="editor"  rows={8}  onChange={onChange} className="block w-full text-sm text-gray-800 bg-white border-0 p-5 focus:border-0 focus:outline-none" placeholder="Write an article..." required ></textarea>
                </div>
            </div>
        </div>
